...
#define CMD_DIR_HELP "dir <inode number> - display the content of all the data blocks in a inode directory"
...
#define CMD_LIST_HELP "list - list all the deleted files"
